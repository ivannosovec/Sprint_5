...
class TestStellarBurgersRegistration:
    ...
    def test_registration_empty_name_nothing_happens(self, driver):
        ...
        driver.find_element(*AuthRegistre.ar_email_field).send_keys('burger3@yan.ru')
        driver.find_element(*AuthRegistre.ar_password_field).send_keys('1245678')
    ...
    @pytest.mark.parametrize('email_list', ['burger3@yanru', 'burger5yan.ru', 'te st3@yan.ru', 'test4@ya n.ru',
